...
insert into Capa(idCapa, capa_imagem) values(1, "https://www.cut.org.br/images/cache/systemuploadsnews04e51e507bdbff04e6f-700x460xfit-cd5da.jpeg");
insert into Capa(idCapa, capa_imagem) values(2, "https://nutricaoesaudeanimal.com.br/wp-content/uploads/2021/12/GettyImages-638564582-780x450.jpg");
...
insert into Galeria(idGaleria, descricao, dataCriacaoGaleria, Capa_idCapa) values (1, "Esta galaria só tem imagens belas", "2022-11-01", 1);
insert into Galeria(idGaleria, descricao, dataCriacaoGaleria, Capa_idCapa) values (2, "Esta galeria tem grandes imagens", "2022-11-01", 2);
